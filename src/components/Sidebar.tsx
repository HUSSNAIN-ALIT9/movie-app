...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed top-0 left-0 h-full w-16 bg-[#181920] flex flex-col items-center pt-24 gap-6 shadow-lg z-40">
      ...
      >
        <svg width="26" height="26" viewBox="0 0 24 24" stroke="#fff" fill="none" strokeWidth="2">
          <path d="M12 21s-6-4.35-9-8.5C-1.5 7.5 3.5 3 8.5 7.5L12 11l3.5-3.5C20.5 3 25.5 7.5 21 12.5c-3 4.15-9 8.5-9 8.5z" />
        </svg>
      </button>
